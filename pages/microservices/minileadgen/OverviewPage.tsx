...
const PipelineDiagram: React.FC = () => {
    // FIX: Explicitly type the `icon` property as React.ReactElement to fix cloneElement error.
...
// FIX: Change `icon` prop type from `React.ReactNode` to `React.ReactElement` for type safety with cloneElement.
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
                <AgentCTA to="/microservices/mini-leads/hunter" title="Agent 1: Hunter" description="Start a new lead hunt &rarr; Find fresh prospects" icon={ICONS.research} />
                <AgentCTA to="/microservices/mini-leads/researcher" title="Agent 2: Researcher" description="Enrich your scraped leads &rarr; Unlock insights" icon={ICONS.dna} />
                <AgentCTA to="/microservices/mini-leads/personalizer" title="Agent 3: Personalizer" description="Turn insights into persuasive emails &rarr; Set tone & style" icon={ICONS.email} />
                <AgentCTA to="/microservices/mini-leads/outreach" title="Agent 4: Outreach" description="Launch campaigns &rarr; Get replies & meetings" icon={ICONS.paperPlane} />
                <AgentCTA to="/microservices/mini-leads/replier" title="Agent 5: Replier" description="Review AI-handled replies &rarr; Manage escalations" icon={ICONS.reply} />
            </div>
