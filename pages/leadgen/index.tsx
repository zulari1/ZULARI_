...
const agentNavLinks: { path: string, name: string, icon: React.ReactElement }[] = [
    { path: '/leadgen', name: 'Overview', icon: ICONS.dashboard },
    { path: '/leadgen/hunter', name: 'Hunter', icon: ICONS.research },
    { path: '/leadgen/researcher', name: 'Researcher', icon: ICONS.dna },
    { path: '/leadgen/personalizer', name: 'Personalizer', icon: ICONS.email },
    { path: '/leadgen/outreach', name: 'Outreach', icon: ICONS.paperPlane },
    { path: '/leadgen/replier', name: 'Replier', icon: ICONS.reply },
    { path: '/leadgen/replier-training', name: 'Replier Training', icon: ICONS.training },
];
...
const LeadGenerationPage: React.FC = () => {
    ...
    const getPageTitle = () => {
        const currentLink = agentNavLinks.find(link => location.pathname.startsWith(link.path) && (link.path !== '/leadgen' || location.pathname === '/leadgen'));
